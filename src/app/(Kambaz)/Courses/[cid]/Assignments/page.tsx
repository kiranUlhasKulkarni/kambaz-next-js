    ...
    <div id="wd-assignments" className="p-4">
            ...
            <div className="d-flex align-items-center flex-grow-1">
              ...
              <div>
                ...
                <div className="text-secondary fs-6">
                  ...
                  May 6 at 12:00am <span className="fw-bold">Due </span>May 13 at
                  11:59pm | 100 pts
                </div>
              </div>
            </div>
            ...
            <div className="d-flex align-items-center flex-grow-1">
              ...
              <div>
                ...
                <div className="text-secondary fs-6">
                  <span className="text-danger">Multiple Modules </span>|
                  <span className="text-muted fw-bold"> Not available until </span>
                  May 13 at 12:00am <span className="fw-bold">Due </span>May 20 at
                  11:59pm | 100 pts
                </div>
              </div>
            </div>
      ...
      <ListGroup className="rounded-0 mb-4">
        ...
        <ListGroupItem className="wd-assignment-status-border p-2">
          <div className="d-flex align-items-center justify-content-between">
            <div className="d-flex align-items-center flex-grow-1">
              <BsGripVertical className="me-2 fs-2" />
              <FaRegFileAlt className="text-primary me-3 fs-2" />
              <div>
                <Link
                ...
                <div className="text-secondary fs-6">
                  <span className="text-muted fw-bold">Due </span>May 10 at 11:59pm | 20 pts
                </div>
              </div>
            </div>
            <div className="d-flex align-items-center ms-3">
          ...
          <div className="d-flex align-items-center justify-content-between">
            <div className="d-flex align-items-center flex-grow-1">
              ...
              <div>
                ...
                <div className="text-secondary fs-6">
                  <span className="text-muted fw-bold">Due </span>May 17 at 11:59pm | 25 pts
                </div>
              </div>
            </div>
            <div className="d-flex align-items-center ms-3">
      ...
      <ListGroup className="rounded-0 mb-4">
        <ListGroupItem variant="secondary" className="p-2">
          <div className="d-flex align-items-center">
            <BsGripVertical className="m-2 fs-4" />
            <span className="fw-bold text-uppercase m-2">EXAMS</span>
            <FaCaretDown className="m-2" />
          </div>
        </ListGroupItem>
        <ListGroupItem className="p-2 text-secondary">No exams assigned</ListGroupItem>
      </ListGroup>
      ...
      <ListGroup className="rounded-0">
        <ListGroupItem variant="secondary" className="p-2">
          <div className="d-flex align-items-center">
            <BsGripVertical className="m-2 fs-4" />
            <span className="fw-bold text-uppercase m-2">PROJECT</span>
            <FaCaretDown className="m-2" />
          </div>
        </ListGroupItem>
        <ListGroupItem className="p-2 text-secondary">No project assigned</ListGroupItem>
      </ListGroup>
    </div>
  );
}
